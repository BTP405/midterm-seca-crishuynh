...
class TestCourseManagementSystem(unittest.TestCase):
    ...
    def test_submit_grade(self): # 6 marks
        ...
        self.assertEqual(self.student1.grades[self.course1.course_name][self.assignment1_type], 90)
        self.student2.submit_grade(self.course1, self.assignment1, 85)
        self.assertEqual(self.student2.grades[self.course1.course_name][self.assignment1_type], 85)
        self.student2.submit_grade(self.course1, self.exam1, 75)
        self.assertEqual(self.student2.grades[self.course1.course_name][self.exam1_type], 75)
